...
my $RE_site = 'GATC'; # the restriction enzyme site at which the DNA was cut for the Hi-C experiment

# Paths to the necessary scripts and software packages.
my $make_bed_around_RE_site_pl = '/cluster/home/xfu/Project/Gossypium_trilobum/canu/HiC/script/make_bed_around_RE_site.pl';
my $bedtools = '/cluster/home/xfu/miniconda2/envs/gmatic/bin/bedtools';
my $samtools = '/cluster/home/xfu/Project/Gossypium_trilobum/canu/HiC/samtools-0.1.18/samtools';
#my $mem = "16G";
