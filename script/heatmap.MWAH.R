...
heatmap.file <- 'Lachesis_out/heatmap.txt'
jpeg.file <- "Lachesis_out/HiC_heatmap.jpg"
...
chrom.borders <- as.numeric( scan( 'Lachesis_out/heatmap.chrom_breaks.txt', quiet=TRUE ) )
